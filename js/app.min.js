(() => {
          ...
          if (e.select) {
            ...
            if (a.length)
              for (let t = 0; t < a.length; t++) {
                const s = a[t].querySelector("select");
  ...
  class r {
    constructor(e) {
      e.length &&
        (this.elements = Array.from(e).map((e) => new r.Each(e, this.options)));
    }
    destroyEvents() {
  ...
  (r.Each = class {
    constructor(e) {
      (this.parent = e),
        ...
        (this.offset = 0),
        (this.value = 0),
        (this.smooth = e.dataset.prlxSmooth
          ? Number(e.dataset.prlxSmooth)
          : 15),
        this.setEvents();
    }
    setEvents() {
    ...
    animationFrame() {
      const e = this.parent.getBoundingClientRect().top,
        ...
        s = e - a,
        i = e + t,
        r = this.parent.dataset.prlxCenter
    ...
    document.querySelectorAll("[data-prlx-parent]") &&
      (e.parallax = new r(document.querySelectorAll("[data-prlx-parent]")));
  let n = !1;
  setTimeout(() => {
    if (n) {
  ...
  new (class {
      ...
      (this.оbjects = []),
        ...
        this.mediaQueries.forEach((e) => {
          const t = e.split(","),
            ...
            s = t[1],
            i = this.оbjects.filter(({ breakpoint: e }) => e === s);
    ...
    document.addEventListener("click", function (e) {
      const t = e.target;
      if (t.closest("[data-ripple]")) {
        const a = t.closest("[data-ripple]"),
          s = document.createElement("span"),
          i = Math.max(a.clientWidth, a.clientHeight),
          r = i / 2;
        (s.style.width = s.style.height = `${i}px`),
          (s.style.left =
            e.pageX - (a.getBoundingClientRect().left + scrollX) - r + "px"),
          (s.style.top =
            e.pageY - (a.getBoundingClientRect().top + scrollY) - r + "px"),
          s.classList.add("ripple"),
          "once" === a.dataset.ripple &&
            a.querySelector(".ripple") &&
            a.querySelector(".ripple").remove(),
          a.appendChild(s);
        const n = o();
        function o() {
          const e = window.getComputedStyle(s).animationDuration;
      ...
      if (
        (document.body.addEventListener("focusin", function (e) {
          ...
          ("INPUT" !== t.tagName && "TEXTAREA" !== t.tagName) ||
            ...
            i.removeError(t),
            t.hasAttribute("data-validate") && i.removeError(t));
        }),
          ...
          t.forEach((e) => {
            ...
            a(e, Math.min(t, s)),
              e.addEventListener("input", () => {
                e.scrollHeight > t &&
                  ((e.style.height = "auto"),
                  a(e, Math.min(Math.max(e.scrollHeight, t), s)));
              });
          });
        }
      }
